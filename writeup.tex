...
%TCIDATA{LastRevised=Friday, May 29, 2020 11:43:57}
...
The customer margin has attracted interest among trade economists using
customs records. Using Irish data, Fitzgerald et al. (2019) investigate
whether firms build their customer base through non-price marketing efforts
versus price discounts to establish a market presence. They find little role
for discounting, but an important role for the customer base. Using French
data, Pivetau (forthcoming) also investigates the importance of discounts
versus non-price efforts to build a customer base. Unlike Fitzgerald et al.
...
important advantage. Like the present paper, these are both based on
single-agent dynamic models with passive customers. We differ from them in
that we allow for learning effects, search frictions, and the endogenous
evolution of buyer-seller relationship. [\textit{To be excised: Also, they
copied us with minimal acknowledgement but finished more quickly}.] From a
very different perspective, Chaney (2014) uses customs records to model the
emergence of international trading networks as a contagion penomhenon, with
exporters tending to break into markets that are geographically close to
those that are they already service. 

Other papers with a consumer margin shift the focus to market equilibria
with heterogeneity on both the importer and the exporter side of the market.
Eaton et al. (2016) treat both buyers and sellers as searching for each
other in a dynamic market equilibrium. They, too, find an important role for
the effect of existing business relationships on market visibility and
matching rates. Finally, Blum et al. (2010, 2012), Bernard et al. (2018) and
Sugita et al. (2019) explore the buyer-seller matching patterns that emerge
in a full-information world when both are heterogeneous and fixed matching
costs and/or production complementarities determine who matches with whom.%
\footnote{%
Bernard and Moxnes (2018) provide a useful summary of the literature on
networks and trade.} While this strand of the literature focuses on
assortative matching patterns and their implications for firm-level
efficiency in a static context, our paper is primary concerned with the
formation, maturation and expiration of buyer-seller relationships in a
world with information frictions. 
