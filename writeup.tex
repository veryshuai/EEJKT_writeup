...
%TCIDATA{LastRevised=Sunday, May 31, 2020 15:25:27}
...
calibrated general equilibrium models with idiosyncratic productivity shocks
that move firms through the size distribution. These include Alessandria and
Choi (2007), Ruhl (2007),Alessandria (2010), Atkeson and Burstein (2010),
Burstein and Melitz (2012), Impullitti et al. (2012), and Arkolakis (2015).
We depart from this literature by focussing on firm growth due to
forward-looking investments in their client base rather than investments in
innovation or exogenous productivity processes. Also, unlike most of this
literature, we treat sunk entry costs as incurred at the buyer-seller match
...
These latter features of our model allow us to explain why new exporters who
don't exit tend to rapidly expand, and why established exporters' sales are
relatively stable. They also explain why many firms export for short periods
on a very small scale.

The customer margin has been explored in other papers. One strand of this
literature develops general equilibrium models. By positing that firms face
marketing costs that are convex in the number of foreign clients they
...
business cycle shocks. Gourio and Rudanko (2014)\ study a closed economy,
but they use also search frictions and convex search costs to make firms'
customer base state-dependent. . .

Another strand of the literature using single-agent models to study firms'
customer accumulation in foreign markets. Contributions therein generally
rely on customs records. Using Irish data, Fitzgerald et al. (2019)
investigate whether firms build their customer base through non-price
marketing efforts versus price discounts to establish a market presence.
They find little role for discounting, but an important role for the
customer base. Using French data, Pivetau (forthcoming) also investigates
the importance of discounts versus non-price efforts to build a customer
base. Unlike Fitzgerald et al. (2019), he finds a tendency for firms to
discount their goods when they are new to a market, but he confirms that a
large existing customer base improves product awareness in the remainder of
the population and conveys an important advantage. Our model is perhaps
closest to these papers, in that it is also a single-agent model fit to
customs records. [\textit{Tempting to write: They copied us with minimal
acknowledgement but finished more quickly}. \textit{Fitzgerald et al.
especially annoying: added learning to their most recent version; EEJKT
acknowledged only as a general "see also" mention in a footnote of intro.}]
But we differ from them in that we study the joint evolution of home and
foreign sales for each firms, allow for endogenous entry and exit in both
markets, learning effects, search frictions. Also we characterize the
life-cycle of successful matches, including their endogenous dissolution.%
\footnote{%
...
Other papers with a consumer margin use customs records to analyze
assortative matching patterns between exporters and importers. Blum et al.
(2010, 2012), Bernard et al. (2018) and Sugita et al. (2019) use static
models to explore the buyer-seller matching patterns that emerge in a
full-information world. Productivity heterogeneity on both sides of the
market, fixed matching costs, and/or production complementarities determine
who matches with whom.\footnote{%
Bernard and Moxnes (2018) provide a useful summary of the literature on
networks and trade.} Closer to the present paper is Eaton et al. (2016),
which treats both buyers and sellers as building client portfolios by
searching for each other in a dynamic market equilibrium. They, too, find an
...
Matching and/or screening frictions appear in a number of theoretical models
of new exporter dynamics that are supported by reduced form evidence. In
Rauch and Watson (2003), importers experiment with foreign suppliers by
placing trial orders with them, and they gain access to a supplier network
if they establish a successful business relationship. We take the assumption
that importers evaluate a sample shipment before forming business
relationships from this formulation. In Albornoz et al (2012), firms choose
to experiment in markets with low entry costs in order to learn about their
product's appeal elsewhere. Our model resembles theirs in that exporters
...
patterns that we target. \textbf{[JT: this paragraph was based on
