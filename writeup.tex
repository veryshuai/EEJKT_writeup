...
%TCIDATA{LastRevised=Tuesday, August 11, 2020 16:20:41}
...
Fit to customs records describing U.S. manufactured imports from Colombia,
...
matches early in their market exploration encourages more intense search and
thereby improves visibility. Finally, export responses to permanent
devaluation are more muted and gradual in our model than in other
treatments, and they exhibit substantial hysteresis.
...
Figures \ref{fig:export_dynamics_macro}, inspired by the decomposition plots
in Piveteau (2020), summarize the macroeconomic effects of our exchange rate
experiments. They break down the total value of exports into the
contribution from (1) buyer-seller relationships that existed at the time of
the shock (yellow), (2) new relationships with exporters that were already
in the market at the time of shock (orange), and relationships with
exporters that were not in the market at the time of the shock (blue). The
pre-shock time period shows only the aggregate value of exports, which is
somewhat confusingly color-coded as yellow. \textbf{[JT: David, please
confirm. If correct, shall we start the graphs at period 25?]}
...
study? To address this question we plot the percentage decomposition of each
aggregate in Figure \ref{fig:export_dynamics_average}. Summarizing the
figures, when the exchange rate shock is favorable, all margins maintain
their relative importance, but with an unfavorable shock, new matches gain
market share relative to incumbents. As discussed above, this asymmetry
reflects the fact that negative shocks cause exporters to immediately
terminate their marginal matches, "cleansing" the market of
low-profitability relationships.  \textbf{[JT: mention rapid drop of
relationships in Gopinath and Neiman here?}] Percentage-wise, the negative
effect of appreciation on incumbent exporters' sales share is bigger than
its effect on their match share because . . . \textbf{[JT: can we say
anything about role of learning effects]}

Finally, we present short and long-run simulated trade elasticities. These
are presented in Table \ref{tab:elasticities}. Based on the point estimates
alone, total sales react more to the favorable exchange rate shock. The 25
year elasticity of sales to the favorable exchange rate shock is 2.22.%
\footnote{%
...
These elasticities are smaller than those reported by Piveteau (2020),
Alessandria and Choi (2014), and Alessandria, et al. (2018). \textbf{[JT:
need to add details.] }Moreover, they suggest a substantially longer
transition period.
