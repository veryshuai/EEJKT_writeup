...
dollars. After the shock, the values ultimately converge to around 20 percent higher or lower than before the shock, but the change in value on impact is larger. For the positive shock, this pattern reflects the role of matching frictions, which delay the entry of marginally productive firms. For the negative shock, the pattern reflects the role of fixed costs and relationship-specific shocks, which cause the eventual termination of matches at some marginally productive firms. The transition patterns for the positive-shock and negative-shock means are nearly mirror images of eachother (panel $a$), but the medians reveal more overshooting for the positive shock with a lower long run effect (panel $b$), implying that positive shocks tend to gradually increase the right-skewness of the value distribution.
