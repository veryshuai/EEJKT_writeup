...
The shaded ares in these figures break down the total value of an export aggregate---sales, matches, or exporters---into Each panel also includes a set of thin lines that show how the boundaries between the shaded areas would have been different if there had been no permanent shock.%
\footnote{% 
