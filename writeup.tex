...
%TCIDATA{LastRevised=Thursday, August 06, 2020 15:16:57}
...
By making the number of signals a firm receives depend upon the number of
potential buyers it matches with--successfully or otherwise--we create an
extra incentive for new exporters to search more intensively than
established exporters. In this way (inter alia) we depart from earlier
papers that model the number of signals received per period as either zero
or one, depending upon firms' foreign market participation (Fitzgerald et
al., 2019; Arkolakis et al., 2018; Timoshenko, 2015). We will quantify the
importance of this incentive in Section 6 below.
