...
%TCIDATA{LastRevised=Monday, August 10, 2020 17:23:02}
...
firm's products with each successful buyer-seller match the firm
establishes. 
...
luck in the establishment of new exporters, since a few successful matches
early in their market exploration encourages more intense search. Two firms
with the productivity and product appeal may take a few years or many years
to establish 10 successful business relationships. Finally, export responses
to permanent devaluation are more muted and gradual in our model than in
...
about its success rate $\theta$. In addition, this firm has accumulated
...
around 20\% higher or lower than before the shock, but the change in value
on impact is larger. This is due to the lagged entry of marginally
...
average around 18\% of the total value of firms both before and after the
exchange rate shocks. For a back-of-the-envelope calculation of the total
value of experience in the economy, we multiply 1.7 million dollars by the
approximately 3000 Colombian exporters we observe each year. We get that the
total value of exporter experience in the Colombian economy is about 5.1
billion dollars.
...
experiments. Our model is a different from Piveteau (2020) in several
important ways which affect the decompositions we do. In particular, we have
firm entry and exit, as well as endogenous drops of matches. In principle
both of these margins could be important as firms enter to take advantage of
favorable exchange rate shocks, and firms drop matches in response to
negative shocks. For this reason, our decomposition will be between new
exporters, incumbent firms and new matches, and incumbent firms and
incumbent matches. Endogenous entry of exporters and exits of matches will
potentially create asymmetries in the macroeconomic effects of favorable and
unfavorable exchange rate shocks, which is why we do both experiments.

Consider Panel (a) and Panel (b) of Figure \ref{fig:export_dynamics_macro}
plot total export sales over a 50 year period bisected by the shock. The
superimposed lines show the decomposition in the situation in which there
was no change in the exchange rate. Relationships with incumbent importers
are relatively short-lived in our model because of the high exogenous match
death hazard rate. New firms become more important over time.

The immediate effect of the favorable depreciation (Panel (a)) is to
increase the peso-denominated revenue flow from existing clients by 20
percent, and to decrease it 20 percent in the unfavorable shock (Panel (b)).
...
first post-shock year. As time progresses, both new importers and new firms
become more and more important. Additionally, the total effect of the
exchange rate shock grows.
...
plays no role. There is therefore only a small change the first year after
the shock. Panels (e) and (f) show the mean number of firms per simulation.
New firms quickly displace around 15\% of incumbent firms, and then the
...
We also plot the percentage decomposition of these macroeconomic aggregates
in Figure \ref{fig:export_dynamics_average}. Summing up the figures, when
the exchange rate shock is favorable, incumbent matches are less important,
and when the exchange rate shock is unfavorable, incumbent matches are more
important. This is because exporters search harder for new matches when the
exchange rate shock is favorable, and less hard when the exchange rate shock
is unfavorable. For the most part, incumbent relationships continue.
...
than to unfavorable exchange rate shocks.
