...
Several clear messages emerge from this exercise. First, entering cohorts capture market share from the pre-shock incumbent cohorts at almost exactly the same pace, regardless of whether learning effects or visibility effects are present. This is apparent from the fact that the borders between the orange and yellow regions nearly coincide with the dashed red and green lines. Second, however, if firms had known their true $\theta^{f}$ values before acquiring foreign market experience, substantially more would have entered in the post-shock period.  Third, visibility effects matter a bit, especially for total active matches, but they actually reduce the share of new exporters relative to the case where $\theta^{f}$ draws are known with certainty but visibility must be gradually built through successful matches. Finally, none of these patterns depends upon whether we are considering a permanent appreciation or a permanent depreciation--they are general features new cohort maturation processes.
