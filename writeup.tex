...
%TCIDATA{LastRevised=Friday, May 29, 2020 10:59:33}
...
customs records, including Eaton et al. (2019), Fitzgerald et al. (2019) and
Pivetau (forthcoming). Using Irish data, Fitzgerald et al. (2019)
...
the population and conveys an important advantage. From a very different
perspective, Chaney (2014) uses customs records to model the emergence of
international trading networks as a contagion phenomenon, with exporters
tending to break into markets that are geographically close to those that
are they already service. Finally, Blum et al. (2010, 2012), Bernard et al.
(2018) and Sugita et al. (2019) explore the buyer-seller matching patterns
that emerge in a full-information world when both are heterogeneous and
fixed matching costs and/or production complementarities determine who
matches with whom.\footnote{%
