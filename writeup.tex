...
{fig:export_dynamics_average}, which plot the percentage contribution of each type of export to exports aggregates. Note that the post shock transition patterns in all figures coincide very closely with the no-shock (thin line) patterns.
