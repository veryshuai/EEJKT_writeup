...
It is noteworthy that the post shock transition patterns in all figures coincide very closely with the no-shock (thin line) patterns. Hence we were only interested in the rate at which new exporters displace incumbent exporters, or the rate at which new matches displace incumbent matches, it would matter very little whether we were analyzing the aftermath of a permanant devaluation, a permanent revaluation, or a period without any regime swithing. This is apparent from Figure \ref{fig:export_dynamics_average}, which plots the percentage contribution of each type of match to each of the export aggregates.  
