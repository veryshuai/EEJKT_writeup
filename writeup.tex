...
Several clear messages emerge from this exercise. First, entering cohorts capture market share from the pre-shock incumbent cohorts at almost exactly the same pace, regardless of whether learning effects or visibility effects are present. This is apparent from the fact that the border between the orange and the yellow region nearly coincides with both the dashed red and the dashed green lines. Second, however, if firms were to know their true $/theta^{f}$ values before acquiring foreign market experience, substantially more would enter in the post-shock period.  Third, visibility effects matter a bit, especially for total active matches, but they actually reduce the share of new exporters relative to the case where $/theta^{f}$ draws are know with certainty but visibility must be gradually built through matches. Finally, none of these patterns depends upon whether we are considering a permanent appreciation or a permanent depreciation--they are general features new cohort maturation processes.
