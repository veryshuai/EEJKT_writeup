...
Several regressions were done in real pesos within the Colombian national statistical agency (DANE). We are not confident that they can be expressed in units that are strictly comparable to the real dollar units in which U.S.
customs records were expressed.\medskip} We now briefly describe these regressions, our reasoning in choosing them, and the parameters they help most to identify. These observations regarding identification are based partly on our calculation of Andrews et al.'s (2017) sensitivity matrix, which we report in full in Appendix C.
...
reports from other sources.\medskip} Equations ($viii$) is an AR1 for home sales,
